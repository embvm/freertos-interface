# Embedded Virtual Machine FreeRTOS OS Support

This library provides an implementation for the Embedded VM operating system interfaces that supports FreeRTOS.
...
This library provides an implementation for the Embedded VM operating system interfaces that supports FreeRTOS. This library is typically coupled with a specific processor FreeRTOS dependency, since you will require additional files that are processor-specific.

**[Back to top](#table-of-contents)**

# Project Status

This project is being used on two embedded platforms. No major improvements are currently planned; we will be monitoring for bug fixes and performance improvements.
